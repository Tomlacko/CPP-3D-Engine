...
struct LightUBO {
    ...
    LightUBO(float radius, float x, float y, float z, float r, float g, float b)
    : position(x, y, z, radius/*static_cast<float>(type)*/), diffuse_color(r, g, b, 1), specular_color(r, g, b, 1) {}
